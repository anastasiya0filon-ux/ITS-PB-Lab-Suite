...
PART1_COMPONENTS = {
    "Ацетальдегид", "Спирт метиловый", "Ацетон", "Метилацетат",
    "Этилацетат", "Спирт изопропиловый", "Спирт пропиловый",
    "Спирт бутиловый", "н-Пропилацетат", "Бутилацетат",
}
PART2_COMPONENTS = {
    "Гексан", "Гептан", "Бензол", "Акрилонитрил", "Толуол",
    "Этилбензол", "п-Ксилол", "м-Ксилол", "м- п- Ксилолы",
    "о-Ксилол", "Изопропилбензол", "Стирол", "альфа-Метилстирол",
}
